package com.diego.zametki.Adapter;
...
import com.diego.zametki.NotesClickListener;
import com.diego.zametki.R;
...
public class NotesListAdapter extends RecyclerView.Adapter<NotesViewHolder>{
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder holder, int position) {
        ...
        if (list.get(position).isPinned()){
            holder.imageView_pin.setImageResource(R.drawable.pin_icone);
        } else {
...
class NotesViewHolder extends RecyclerView.ViewHolder {
    ...
    //Объявляем объекты (Элементы) которые мы добавили в файл notes_list.xml
